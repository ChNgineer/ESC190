import sys
from press_utilities import insert_word, redefine_word, delete_word, search_for_word, search_for_subset, search_for_sequence, load_save, save
import os
...
if(__name__ == "__main__"):
    ...
    while(True):
        ...
        if(user.lower() == "insert"):
            ...
            del Authors[N_Psi_dict[word].author]
